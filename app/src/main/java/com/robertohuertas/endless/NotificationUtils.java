...
public class NotificationUtils {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "ENDLESS SERVICE CHANNEL";
    private static final String NOTIFICATION_CHANNEL_NAME = "ENDLESS SERVICE CHANNEL";
    ...
    private static Notification createNotification(@NonNull Context context) {
        ...
        builder.setContentText("KHÔNG XEM");
